import { check, neurosymbol } from "../assets";
      ...
      <div className="container lg:flex">
        <div className="max-w-[25rem]">
          <h2 className="mb-4 h2 md:mb-8">
            AI Music Generator for Seamless Collaboration
          </h2>
          ...
          <div className="relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100">
            ...
            <ul>
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    className={`relative animate-pulse -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/15 rounded-xl -rotate-${
                      index * 45
                    }`}
                  >
                    <img
